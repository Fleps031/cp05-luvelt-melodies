            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="card-review bg-white p-6 rounded-lg shadow-lg">
                ...
                <div className="flex items-center">
                  <img className="h-10 w-10 rounded-full" src="https://via.placeholder.com/40" alt="Usuário"/>
                  <div className="ml-4">
              ...
              <div className="card-review bg-white p-6 rounded-lg shadow-lg">
                ...
                <div className="flex items-center">
                  <img className="h-10 w-10 rounded-full" src="https://via.placeholder.com/40" alt="Usuária"/>
                  <div className="ml-4">
