    ...
    return (
      <>
        ...
        <div className="flex flex-col lg:flex-row bg-white justify-center items-center px-4">
          ...
          <div className="flex flex-col m-4 gap-5 p-8 w-full sm:w-[500px] md:w-[600px] h-auto sm:h-[400px] md:h-[500px] rounded-lg card-review bg-white text-black transition-transform duration-300 ease-in-out hover:translate-y-[-4px] shadow-[0_10px_15px_#d772a6] hover:shadow-pink">
